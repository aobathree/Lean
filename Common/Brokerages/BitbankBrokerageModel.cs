...
namespace QuantConnect.Brokerages
{
    ...
    public class BitbankBrokerageModel : DefaultBrokerageModel
    {
        ...
        /// </summary>
        public override IReadOnlyDictionary<SecurityType, string> DefaultMarkets => GetDefaultMarkets(Market.Bitbank);
        ...
        {
            var symbol = Symbol.Create("BTCJPY", SecurityType.Crypto, Market.Bitbank);
